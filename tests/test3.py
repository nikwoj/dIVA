...
def test3(X, A, verbose=False) :
    '''
    Fix total number of subjects, increase sites and number of subjects per site. Iterations in this test refers to number of sites.
    '''
    N,R,K = X.shape
    values = []
